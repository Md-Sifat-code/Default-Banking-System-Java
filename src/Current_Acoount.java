public class Current_Acoount extends Account {public String account_type;
    public Current_Acoount(String name, String NID_Card,double balance,String account_type){
